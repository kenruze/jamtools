//shader supporting vertex colour, texture, tint, and amplification
//with blend transparency

Shader "DiffVertCA-amp"
{
	Properties 
	{
...
o.Albedo = Multiply3;
o.Alpha = float4( Split0.w, Split0.w, Split0.w, Split0.w);
